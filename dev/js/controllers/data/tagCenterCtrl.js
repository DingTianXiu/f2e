 ...
 * 标签表管理
 */
app.controller('tagCenterCtrl', ['$scope', '$cookies', 'globalConfig', 'dataService', '$rootScope','toaster',
    function ($scope, $cookies, globalConfig, dataService, $rootScope,toaster) {
        ...
        function load(josnList) {
            ...
            dataService.getData('queryLabelsAdvance',{deployed: true}).success(function (rs) {                $scope.g = $("#tables_con_show").ligerGrid({
...
// 删除标签信息
function stopOrStartLabel(id,type) {
    //TODO
    var tit='确认停用所选标签吗？'
    var url='/wlgfapi/batch/stopOlineLabel'
    var res='停用成功'
    if(type==1){
        tit='确认启用所选标签吗？'
        url='/wlgfapi/batch/startOlineLabel'
        res='启用成功'
    }
    var params = {
        id: id
