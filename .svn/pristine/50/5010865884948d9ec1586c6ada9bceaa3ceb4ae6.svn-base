 ...
 * 全局大框
 */
app.controller('gCtrl', ['$scope', '$state', '$stateParams', '$cookies', '$localStorage', '$window', 'globalConfig',
	function($scope, $state, $stateParams, $cookies, $localStorage, $window, globalConfig) {
		// 用户信息
